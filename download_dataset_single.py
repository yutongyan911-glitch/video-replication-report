...
if __name__ == "__main__":
    input_file = "/Users/zhangshuaiyu/Downloads/Omni_视频编辑_V4_v1.0_1776686413809.xlsx"
    output_dir = "/Users/zhangshuaiyu/Desktop/OmniVideo/dataset/Omni_V4_视频编辑"
    ...
    def download_one(ref: str, dest: Path) -> bool:
        ok = download_ref(client, ref, dest)
        file_pbar.update(1)
        return ok

    with tqdm(desc="下载文件", unit="个") as file_pbar:
